...
#' Mixture SNP Cutoff (Truncated)
#'
#' Same as mixture_snp_cutoff but truncates after a certain number of SNPs.
#'
...
#'
#' @export
mixture_snp_cutoff_trunc <- function(trans_snp_dist, unrelated_snp_dist, trans_time_dist=NA, trans_sites=NA,
