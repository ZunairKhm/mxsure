...
#' @examples
#'
mxsure_likelyhood_contour <- function(trans_snp_dist, unrelated_snp_dist, trans_time_dist, trans_sites, threshold=NA, truncation_point=NA,
  ...
  result <- suppressWarnings(
    mixture_snp_cutoff(
      trans_snp_dist,unrelated_snp_dist, trans_time_dist, trans_sites, truncation_point=truncation_point, start_params = NA,
